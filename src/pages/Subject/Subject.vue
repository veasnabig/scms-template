...
<div>
    ...
    <Dialog :showSubjectDialog='showSubjectDialog' :cardItem='cardItem' :subjectItem='subjectItem' @closeDialog='showSubjectDialog=false' />
...
import Dialog from './SubjectDialog';
